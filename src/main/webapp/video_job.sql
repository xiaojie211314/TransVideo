...
CREATE TABLE `video_job` (
  ...
  `msg` text COMMENT '转码错误信息，如果有错误信息就写入',
  `error` text COMMENT '回调错误信息，返回接收到回调接口的信息',
  ...
  `fdsdomain` varchar(500) NOT NULL DEFAULT '' COMMENT 'fastDFS主域名',
  `fdsurl` varchar(500) NOT NULL DEFAULT '' COMMENT 'fds 访问地址',
